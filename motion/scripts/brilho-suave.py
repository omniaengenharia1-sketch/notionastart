...
ALVO = 0.36  # media de cinza desejada (0 a 1) depois do grayscale
...
def main(caminho: Path) -> None:
    ...
    for cena in props['cenas']:
        ...
        # o teto precisa ser alto: foto muito escura que nao alcanca o alvo fica
        # abaixo das vizinhas e o corte entre elas vira flash
        fator = max(0.3, min(4.0, ALVO / max(media, 0.02)))
